...
import { KnownFor, People, SingularPerson } from "./types";
...
export const getPerson = (person_id : string | undefined) => {
  return api<SingularPerson>(`/person/${person_id}?api_key=2e1d9e703d345ef35e7a54d9ac882a26&language=en-US`).then((response) => {
