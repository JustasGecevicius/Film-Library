import{_ as ee,C as te,b as D,g as A,c as ne,d as re,e as se,S as oe,f as ie,F as ae,r as N,u as ue}from"./index-BjH-UxWX.js";import{u as ce}from"./useQuery-CRI9H-0w.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Q="storage";function it(e){return e=A(e),et(e)}function at(e,t){return e=A(e),st(e,t)}function ut(e=se(),t){e=A(e);const r=ne(e,Q).getImmediate({identifier:t}),s=re("storage");return s&&ct(r,...s),r}function ct(e,t,n,r={}){ot(e,t,n,r)}function lt(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),r=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return new F(n,r,s,t,oe)}function ht(){ee(new te(Q,lt,"PUBLIC").setMultipleInstances(!0)),D(L,j,""),D(L,j,"esm2017")}ht();const pt=()=>{const e=ut(),t=at(e,"background.avif"),{data:n}=ce(["link"],()=>it(t),{staleTime:1/0});return n},gt=()=>{const[e,t]=N.useState(),{userInfo:n}=ue();return N.useEffect(()=>{n&&t(n.displayName.split(" ").slice(0,-1).join("."))},[n]),e};export{pt as a,gt as u};
